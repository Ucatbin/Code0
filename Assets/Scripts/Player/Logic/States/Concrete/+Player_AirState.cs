...
{
    public Player_AirState(PlayerController_Main entity, StateMachineOld stateMachine, int priority, string stateName) : base(entity, stateMachine, priority, stateName)
    {
    }
    ...
    {  
        ...
        if (_player.CheckerSys.IsGrounded && !_player.IsJumping)
