...
public class BuffDataSO_CountDown : BaseBuffDataSO
{
    [Header("Settings")]
...
public class BuffItem_CountDown : BaseBuffItem
{
    ...
    public BuffItem_CountDown(BuffDataSO_CountDown buffData, Character caster, Character target, int curStack, TextMeshProUGUI display) : base(buffData, caster, target, curStack)
    {
